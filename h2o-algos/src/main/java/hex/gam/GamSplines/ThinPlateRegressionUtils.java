...
public class ThinPlateRegressionUtils {
  ...
  // generate knots for TP smoothers.  Sort the first predictor column, take quantiles out of the sorted
  // first column and grab the corresponding rows of second, third , ... predictor columns.
